export default {
  ...
  category: {
    ...
    bottomTip: 'Anyway, const\'s look at the other categories'
  },
  // 吃什么
  eat: {
    all: 'All',
  ...
  order: {
    ...
    numbers: 'number:',
    addTip: 'I haven\'t added an address yet, const\'s add one😄',
  ...
  login: {
    ...
    pleaseInputCorrectVerifyNumber: 'Please enter the correct verification code',
