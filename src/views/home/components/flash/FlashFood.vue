<template>
  <div id="flashFood">
    <div class="flashItemwrapper">
      <ul ref="ulWrapper" class="itemWrapper">
        <li
        ...
        >
          ...
          <div class="price">
            ...
            <div class="buyCar" @click.stop="addToCart(product, index)">
              <svg-icon icon-class="car" style="width:1.3rem;height:1.3rem" />
            </div>
          </div>
        </li>
      </ul>
      ...
      >
        <div v-if="item" ref="ball" class="move_dot">
          <!-- 小球图片 -->
...
export default {
  ...
  mounted() {
    this.$nextTick(() => {
      ...
      const el = this.$refs.productItem
